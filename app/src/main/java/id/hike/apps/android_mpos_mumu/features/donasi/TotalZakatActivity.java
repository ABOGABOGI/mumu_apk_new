...
public class TotalZakatActivity extends BaseActivity {

    private Button btnBayarZakat;
    private TextView txtZakatTotal, txtZakatSubtotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_zakat);

        btnBayarZakat = findViewById(R.id.btn_bayar_zakat);
        //btnBayarZakat.setOnClickListener(this);
        txtZakatTotal = findViewById(R.id.txt_zakat_total);
        txtWakafTotal = findViewById(R.id.txt_zakat_total);
        txtZakatSubtotal = findViewById(R.id.txt_zakat_subtotal);

        txtZakatSubtotal.setText(UnitConversion.format2Rupiah(
                getSecPref().getInt(Cfg.prefDonasiAmount, 0)));
        txtZakatTotal.setText(UnitConversion.format2Rupiah(
                getSecPref().getInt(Cfg.prefDonasiAmount, 0) + 0));

        btnBayarZakat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int saldo = getSecPref().getInt(Cfg.prefsWalletSaldo, 0);
                int number = getSecPref().getInt(Cfg.prefDonasiAmount, 0);
                if(saldo < number){
                    new AlertDialog.Builder(TotalZakatActivity.this)
                    ...
                    ProgressDialog dialog = new ProgressDialog(TotalZakatActivity.this);
                            ...
                            .subscribe(new Observer<Response<TrxWallet>>() {
                                ...
                                public void onNext(Response<TrxWallet> trxWalletResponse) {
                                    ...
                                    if ((!rcode.equals("00")) && (!rcode.equals("68"))) {
                                        Intent intent_dialog = new Intent(TotalZakatActivity.this, UtilDialogActivity.class);
                                        intent_dialog.putExtra("text_Title", "Transaksi Zakat");
                                        intent_dialog.putExtra("text_Header", "Transaksi Zakat Tidak Berhasil.");
                                        ...
                                        Intent intent = new Intent(TotalZakatActivity.this, InFrameWalletActivity.class);
                                        int number = getSecPref().getInt(Cfg.prefDonasiAmount, 0);
                                ...
                                public void onError(Throwable e) {
                                    ...
                                    Toast.makeText(TotalZakatActivity.this, "Gagal mendapatkan wallet info", Toast.LENGTH_LONG).show();
                                }
