...
public class InputOtpPassword extends FragmentForm {
        ...
        return Observable.create(new ObservableOnSubscribe<Map<String, Object>>() {
            ...
            public void subscribe(ObservableEmitter<Map<String, Object>> emitter) throws Exception {
                ...
                if(password.length() < 8){
                    Toast.makeText(getContext(), "Password minimal 8 alpha numeric!", Toast.LENGTH_LONG).show();
                    ...
                    registrasiApi.checkOtpPassword(emailRegistered, otp, password).subscribe(new Observer<Response<OtpModel>>() {
                        @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle){
        ...
        View v = inflater.inflate(R.layout.fragment_input_otp_password, container, false);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser){
        ...
        if(isVisibleToUser){
            emailRegistered = getFragSecPrefs().getString("email_lupa_password", "");
