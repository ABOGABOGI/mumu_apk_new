...
public class TelkomFragment extends BaseFragment {
    ...
    @BindView(R.id.rvTelkomTagihan)
    RecyclerView rvTelkomTagihan;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle){
        ...
        View v = inflater.inflate(R.layout.fragment_telkom, container, false);
    ...
    public void onActivityCreated(Bundle bundle){
        ...
        ((Home) getActivity()).homePresenter.setToolbarTitle(getString(R.string.title_pembelian_telco));
    ...
    private void checkTagihan(){
        ...
        rvTelkomTagihan.setVisibility(View.GONE);
    ...
    private void updateTagihan(RVAdapterTagihan adapterTagihan){
        stopAnimation();
        rvTelkomTagihan.setVisibility(View.VISIBLE);


        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());

        rvTelkomTagihan.setLayoutManager(linearLayoutManager);
        rvTelkomTagihan.setAdapter(adapterTagihan);
    }
