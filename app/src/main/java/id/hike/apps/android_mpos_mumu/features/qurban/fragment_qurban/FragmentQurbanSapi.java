...
public class FragmentQurbanSapi extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_qurban_sapi, container, false);

        int hargaSapi = 13500000;

        TextView title = view.findViewById(R.id.titleKurbanSapi);
        Button button = view.findViewById(R.id.nextKurbanSapi);
        button.setOnClickListener(v -> {
            if(isNetworkConnected() == false){
                ...
                secPref.putString(Cfg.HARGA_SAPI, String.valueOf(hargaSapi));
                secPref.apply();
