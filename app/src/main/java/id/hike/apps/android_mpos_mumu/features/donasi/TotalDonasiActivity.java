...
public class TotalDonasiActivity extends BaseActivity {

    private Button btnBayar;
    private TextView txtDonasiSubtotal, txtDonasiTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_donasi);
        btnBayar = findViewById(R.id.btn_bayar_donasi);
        //btnBayar.setOnClickListener(this);
        txtDonasiSubtotal = findViewById(R.id.txt_donasi_subtotal);
        txtDonasiTotal = findViewById(R.id.txt_donasi_total);
        txtWakafTotal = findViewById(R.id.txt_donasi_total);
        txtDonasiSubtotal.setText(UnitConversion.format2Rupiah(
                getSecPref().getInt(Cfg.prefDonasiAmount, 0)));
        txtDonasiTotal.setText(UnitConversion.format2Rupiah(
                getSecPref().getInt(Cfg.prefDonasiAmount, 0) + 0 /*2500*/));

        Log.i("DEBUGTAG","Cfg.gs_WakafInfo_KodeProduk on Total Activity:" + Cfg.gs_WakafInfo_KodeProduk);
        ...
        btnBayar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(saldo < number){
                    new AlertDialog.Builder(TotalDonasiActivity.this)
                    ...
                    ProgressDialog dialog = new ProgressDialog(TotalDonasiActivity.this);
                            ...
                            .subscribe(new Observer<Response<TrxWallet>>() {
                                ...
                                public void onNext(Response<TrxWallet> trxWalletResponse) {
                                    ...
                                    if ((!rcode.equals("00")) && (!rcode.equals("68"))) {
                                        Intent intent_dialog = new Intent(TotalDonasiActivity.this, UtilDialogActivity.class);
                                        intent_dialog.putExtra("text_Title", "Transaksi Donasi");
                                        intent_dialog.putExtra("text_Header", "Transaksi Donasi Tidak Berhasil.");
                                        ...
                                        Intent intent = new Intent(TotalDonasiActivity.this, InFrameWalletActivity.class);
                                        int number = getSecPref().getInt(Cfg.prefDonasiAmount, 0);
                                ...
                                public void onError(Throwable e) {
                                    ...
                                    Toast.makeText(TotalDonasiActivity.this, "Gagal mendapatkan wallet info", Toast.LENGTH_LONG).show();
                                }
