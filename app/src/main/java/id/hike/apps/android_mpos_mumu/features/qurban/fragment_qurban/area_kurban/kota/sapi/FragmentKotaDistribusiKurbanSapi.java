package id.hike.apps.android_mpos_mumu.features.qurban.fragment_qurban.area_kurban.kota.sapi;
...
public class FragmentKotaDistribusiKurbanSapi extends BaseFragment {

    RecyclerView recyclerView;
    List<AreaAdapter> daftarKotaAsal;

    public FragmentKotaDistribusiKurbanSapi() {
