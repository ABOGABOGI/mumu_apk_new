...
public class FragmentProvinsiDistribusiKurbanKambingStandar extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_provinsi_distribusi_kurban_kambing_standar, container, false);
        ...
        recyclerView.addOnItemTouchListener(new ListenerRecyclerItemClick(getContext(), (view1, position) -> {
            ...
            FragmentListProvinsiDistribusiKurban fragmentListProvinsiDistribusiKurban1 = ((FragmentListProvinsiDistribusiKurban) recyclerView.getAdapter());
           ...
           getContext().startActivity(intent);
            ...
            //Toast.makeText(getContext(), Cfg.PROVINSI_DISTRIBUSI_KURBAN, Toast.LENGTH_SHORT).show();
            //fragmentManager.beginTransaction().replace(R.id.activity_main, activityNextQurban).commit();
        }));
